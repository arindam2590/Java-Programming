...
public class WinActionPerformInline
{ 
	...
	WinActionPerformInline(String title, int w, int h)
	{
		...
		//add Action Listner(Click on Button) inline to the Button
    ...
    { 
		new WinActionPerformInline("My First Window", 500, 300);
	}
}